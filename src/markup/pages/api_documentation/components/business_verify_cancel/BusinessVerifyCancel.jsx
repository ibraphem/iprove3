...
import './business_verify_cancel.css';
...
import {  columns1,columns3, 
	// columns5,columns6,columns7,columns8, columns9,
	codeString, error404, codeString_header,curlRequest
 } from './jsondata';
import { Container } from 'react-bootstrap';
SyntaxHighlighter.registerLanguage('jsx', jsx);

const BusinessVerifyCancel = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>CANCEL BUSINESS VERIFICATION</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0" style={{padding:"5px",margin:"5px"}}>
												<h5>Cancel Business Verification</h5>
												<Accordion.Header>
												<input type="button" value="POST" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/business/cancel_verification/{verificationId}`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													<Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='green' /></span>
																				&nbsp;&nbsp;200 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Business Verification canceled successfully</span></p>
																		</Col>
																	</Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='red' /></span>
																				&nbsp;&nbsp;404 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading">Business Verification Request Not Found.</span></p>
																		</Col>
																	</Row>
...
export default BusinessVerifyCancel;