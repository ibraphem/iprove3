...
import './business_verify_get_by_id.css';
...
import {  columns1,columns3, 
	...
	codeString, codeString_header,curlRequest
 } from './jsondata';
import { Container } from 'react-bootstrap';
SyntaxHighlighter.registerLanguage('jsx', jsx);

const BusinessVerifyGetById = () => {
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>Get Business Verification By ID</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<p>Fetch A business verification detail by ID</p>
										</div>
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0" style={{padding:"5px",margin:"5px"}}>
												<h5>Get Business By ID</h5>
												<Accordion.Header>
												<input type="button" value="GET" size="sm" className="myButton" variant="primary"></input>
												&nbsp;&nbsp;&nbsp;&nbsp; <strong><small>{`https://testapi.iprove.ng/identity/api/v1/business/get_verification/{verificationId}`}</small></strong>
												</Accordion.Header>
												<Accordion.Body>
												<Container>
													<Row>
																...
																<Accordion.Header>
																	<Row>
																		<Col sm><p className="paramsb"><span className="circle"><Circle center={[15, 25]} radius={3} color='red' /></span>
																				&nbsp;&nbsp;404 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="paramsHeading"></span></p>
																		</Col>
																	</Row>
									...
									<div className="mb-30">
										...
										<div>
												<ul class="pager">
													<li class="previous">
													<a href="/api/business/verify_cancel">&larr; Prev</a>
													</li>
													<li class="next">
...
export default BusinessVerifyGetById;