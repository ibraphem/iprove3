...
import './business_verify_all.css';
							...
							<div className="row">
								...
								<div className="col-lg-8 mb-30">
									<div className="ttr-media mb-30">
										<h3>GET ALL BUSINESS VERIFICATIONS</h3><hr style={{ color: "black" }} />
									...
									<div className="clearfix">
										...
										<Accordion defaultActiveKey="0">
											<Accordion.Item eventKey="0">
												<h5 style={{padding:"5px",margin:"5px"}}>Get Business Verifications</h5>
												<Accordion.Header>
...
export default BusinessVerifyAll;